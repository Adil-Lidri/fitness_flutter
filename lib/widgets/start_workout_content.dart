...
import 'package:fitness_flutter/widgets/start_workout_video.dart';
import 'package:fitness_flutter/blocs/workoutdetails_bloc.dart' as workout_bloc;
          ...
          nextExercise != null
              ? Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6.5),
                    Text('00:${int.parse(nextExercise!.minutes) > 10 ? nextExercise!.minutes : '0${nextExercise!.minutes}'}')
    ...
    return FitnessButton(
      ...
      onTap: () {
        if (nextExercise != null) {
          /*List<Exercise> exercisesList = BlocProvider.of<workout_bloc.WorkoutDetailsBloc>(context).workout.exercises;
