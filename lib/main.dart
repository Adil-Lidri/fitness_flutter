...
import 'package:fitness_flutter/services/notification_service.dart';
import 'package:fitness_flutter/pages/tab_bar_page.dart';
import 'package:fitness_flutter/pages/welcome-page.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: isLoggedIn ? TabBarPage() : WelcomePage(),
    );
  }
